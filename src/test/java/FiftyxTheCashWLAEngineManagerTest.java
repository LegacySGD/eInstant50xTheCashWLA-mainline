...
public class FiftyxTheCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FiftyxTheCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/50xTheCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/50xTheCashWLAIW/InitOutcome.xml").getDocumentElement();
